...
#ifndef INC_DRAW_ENGINE_WX_ALREADY
#define INC_DRAW_ENGINE_WX_ALREADY
...
namespace draw {
	...
	class wx_sprite_obj : public sprite_obj {
		...
		virtual void Mirror(MIRROR mode) override;
		virtual void OverlaySprite(sprite_ref sr) override;
