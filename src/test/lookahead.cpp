...
R"({ "content" : [ )"
	...
	R"({ "type" : "auto_signal", "name" : "S1", "sighting" : 200000, "max_aspect" : 3 }, )"
	R"({ "type" : "track_seg", "length" : 500000, "name" : "TS1" }, )"
	R"({ "type" : "auto_signal", "name" : "S2", "overlap_end" : true, "sighting" : 200000, "max_aspect" : 3 }, )"
	R"({ "type" : "track_seg", "length" : 500000, "speed_limits" : [ { "speed_class" : "", "speed" : 200 } ], "name" : "TS2" }, )"
	R"({ "type" : "route_signal", "name" : "S3", "route_signal" : true, "overlap_end" : true, "sighting" : 200000, "max_aspect" : 3 }, )"
	R"({ "type" : "track_seg", "length" : 500000, "name" : "TS3"  }, )"
	R"({ "type" : "routing_marker", "overlap_end" : true }, )"
	R"({ "type" : "points", "name" : "P1", "sighting" : 50000 }, )"
	R"({ "type" : "track_seg", "length" : 500000, "speed_limits" : [ { "speed_class" : "", "speed" : 100 } ], "name" : "TS4" }, )"
	R"({ "type" : "route_signal", "name" : "S4", "shunt_signal" : true, "sighting" : 200000, "end" : { "allow" : "route" } }, )"
	R"({ "type" : "track_seg", "length" : 500000 }, )"
	R"({ "type" : "end_of_line", "name" : "B", "end" : { "allow" : "overlap" } }, )"

	R"({ "type" : "track_seg", "length" : 400000, "connect" : { "to" : "P1", "from_direction" : "front" } }, )"
...
R"({ "content" : [ )"
	...
	R"({ "type" : "vehicle_class", "name" : "VC1", "traction_types" : [ "diesel", "AC" ], "length" : "25m", "mass" : "40t" },)"
	R"({ "type" : "start_of_line", "name" : "A" }, )"
	...
	R"({ "type" : "end_of_line", "name" : "B", "end" : { "allow" : "overlap" } } )"
R"(], "game_state" : [)"
	R"({ "type" : "train", "vehicle_classes" : [ "VC1" ] })"
"] }";
