...
R"({ "content" : [ )"
	...
	R"({ "type" : "route_signal", "name" : "S1", "route_shunt_signal" : true }, )"
	R"({ "type" : "track_seg", "length" : 50000 }, )"
	...
	R"({ "type" : "track_seg", "length" : 50000 }, )"
	R"({ "type" : "route_signal", "name" : "S6", "route_shunt_signal" : true }, )"
	R"({ "type" : "track_seg", "length" : 50000 }, )"
	...
	R"({ "type" : "track_seg", "length" : 50000 }, )"
	R"({ "type" : "route_signal", "name" : "S2", "route_shunt_signal" : true, "route_restrictions" : [ { "targets" : "C", "deny" : "route" } ] }, )"
	R"({ "type" : "track_seg", "length" : 50000 }, )"
	...
	R"({ "type" : "track_seg", "length" : 50000 }, )"
	R"({ "type" : "route_signal", "name" : "S4", "reverse_auto_connection" : true, "route_shunt_signal" : true, "through_rev" : { "deny" : "all" }, "overlap_end" : true}, )"
	R"({ "type" : "track_seg", "length" : 50000 }, )"
...
R"({ "content" : [ )"
	...
	R"({ "type" : "4aspectroute", "name" : "S5", "approach_locking_timeout" : [ { "route_class" : "shunt", "timeout" : 1000 }, { "route_class" : "route", "timeout" : 60000 } ] }, )"
	R"({ "type" : "track_seg", "length" : 20000, "track_circuit" : "S5ovlp" }, )"
	R"({ "type" : "routing_marker", "overlap_end" : true }, )"
	R"({ "type" : "track_seg", "length" : 30000, "track_circuit" : "T6" }, )"
...
TEST_CASE( "signal/overlap/nooverlapflag", "Test signal no overlap flag" ) {
	test_fixture_world_init_checked env(
		R"({ "content" : [ )"
			...
			R"({ "type" : "4aspectroute", "name" : "S1" }, )"
			R"({ "type" : "track_seg", "length" : 30000 }, )"
			R"({ "type" : "4aspectroute", "name" : "S2", "no_overlap" : true }, )"
			R"({ "type" : "track_seg", "length" : 20000 }, )"
			R"({ "type" : "end_of_line", "name" : "B" } )"
		"] }"
	);
		...
		test_fixture_world_init_checked env(
			string_format(
				R"({ "content" : [ )"
					...
					R"({ "type" : "4aspectrepeater", "name" : "RS2", "non_aspected" : %s }, )"
					R"({ "type" : "track_seg", "length" : 20000, "track_circuit" : "T1" }, )"
					R"({ "type" : "4aspectauto", "name" : "S3" }, )"
					R"({ "type" : "track_seg", "length" : 20000 }, )"
